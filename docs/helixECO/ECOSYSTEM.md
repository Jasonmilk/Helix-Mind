...
> **版本**：v1.94
> **创建日期**：2026-08-30
> **最后更新**：2026-09-14（Cellrix 证轨五资产语言统一 **ADR-0017** —— 源码与界面文案一律英文，消除「同一屏中英混排」；Anaphase 测试临时目录去竞态（共享唯一目录助手，全量套件连跑 3/3 全绿）；活文档外部参考项目名清理。此前 Anaphase 上游计量捕获 ADR-0038：证轨状态栏三个恒 `—` 的计量格接入真实数据源）
